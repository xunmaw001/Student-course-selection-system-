                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="jsname" name="jsname" class="form-control"
                                                   v-model="ruleForm.jsname" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="jsusername" name="jsusername" class="form-control"
                                                   v-model="ruleForm.jsusername" readonly>
                                        </div>


                                        <div class="form-group col-md-6">
                                            <label>密码</label>
                                            <input id="jspassword" name="jspassword" class="form-control"
                                                   v-model="ruleForm.jspassword" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>头像</label>
                                        <img id="jsimgPhotoImg" width="100" height="100">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jssexValue" name="jssexValue" class="form-control"
                                               v-model="ruleForm.jssexValue" readonly>
                                    </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="jsphone" name="jsphone" class="form-control"
                                                   v-model="ruleForm.jsphone" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="jsidNumber" name="jsidNumber" class="form-control"
                                                   v-model="ruleForm.jsidNumber" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="jsrole" name="jsrole" class="form-control"
                                                   v-model="ruleForm.jsrole" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="kechengId" name="kechengId" class="form-control"
                                                   v-model="ruleForm.kechengId" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xingzhiValue" name="xingzhiValue" class="form-control"
                                               v-model="ruleForm.xingzhiValue" readonly>
                                    </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="shijian" name="shijian" class="form-control"
                                                   v-model="ruleForm.shijian" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="didian" name="didian" class="form-control"
                                                   v-model="ruleForm.didian" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="zhouxueshi" name="zhouxueshi" class="form-control"
                                                   v-model="ruleForm.zhouxueshi" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="rongliang" name="rongliang" class="form-control"
                                                   v-model="ruleForm.rongliang" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="yixuan" name="yixuan" class="form-control"
                                                   v-model="ruleForm.yixuan" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="yuliang" name="yuliang" class="form-control"
                                                   v-model="ruleForm.yuliang" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="xuankeId" name="xuankeId" v-model="ruleForm.xuankeId" readonly type="hidden">
